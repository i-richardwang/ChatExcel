...
export default function Component() {
  return (
    <Section
      title="Solution"
      subtitle="Privacy-First Automation for Practical Tasks"
      description="We focus solely on what matters - automating your repetitive daily tasks while keeping your data completely private. No false promises, just real productivity gains."
