    ...
    plans: [
      {
        ...
        priceAnchor: 19,
        yearlyPriceAnchor: 190,
        features: [
          {
            name: "Up to 50 Excel operations/month",
          },
          { name: "Basic Excel operations" },
      ...
      },
      {
        ...
        yearlyPrice: 290,
        priceAnchor: 49,
        yearlyPriceAnchor: 490,
        features: [
          { name: "Unlimited Excel operations" },
          { name: "Advanced data transformations" },
